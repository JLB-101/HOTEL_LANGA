...
namespace HOTEL_LANGA.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NomeDepartamento,Status")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NomeDepartamento,Status")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
